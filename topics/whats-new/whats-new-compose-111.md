[//]: # (title: What's new in Compose Multiplatform 1.11.0-beta01)
...
You can find the full list of changes on [GitHub](https://github.com/JetBrains/compose-multiplatform/releases/tag/v1.11.0-beta01).
