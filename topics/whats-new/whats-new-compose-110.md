[//]: # (title: What's new in Compose Multiplatform 1.10.1)
...
You can now use the `androidx.compose.ui.tooling.preview.Preview` annotation in the `commonMain` source set.
...
and the [Caching web resources](compose-web-resources.md#caching-web-resources) documentation.
