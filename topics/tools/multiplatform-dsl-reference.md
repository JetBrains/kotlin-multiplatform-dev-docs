...
kotlin {
    sourceSets.all {
        languageSettings.apply {
            languageVersion = "%languageVersion%" // possible values: "1.9", "2.0", "2.1", "2.2", "2.3", "2.4" (EXPERIMENTAL)
            apiVersion = "%apiVersion%" // possible values: "1.9", "2.0", "2.1", "2.2", "2.3", "2.4" (EXPERIMENTAL)
