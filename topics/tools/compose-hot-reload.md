...
Unlike standard [Compose previews](compose-previews.md), which are ideal for viewing isolated components with test data,
Compose Hot Reload directly applies your code changes to a fully running application.
