...
If you are adding tests to an existing project, you may have to replace `shared` in paths
and commands with the name of the module you are testing.

Create the test source set and add the necessary dependencies:

1. Create a directory for tests: `shared/src/desktopTest/kotlin`.
2. In the `shared/build.gradle.kts` file, add the following dependencies:
