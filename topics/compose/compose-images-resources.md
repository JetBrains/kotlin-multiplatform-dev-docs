...
* Multimodule projects are not supported yet. Resources in the top level application module are supported. The JetBrains team is working on adding this functionality in future releases.
