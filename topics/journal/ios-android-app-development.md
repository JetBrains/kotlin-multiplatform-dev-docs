...
Cross-platform development is no longer a compromise but a strategic choice. Before exploring today’s cross-platform technologies, let’s recap why they’ve become such a game-changer for teams [building for both iOS and Android](build-ios-android-apps.md).
