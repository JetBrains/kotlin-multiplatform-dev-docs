...
* **Direct integration**. You connect the framework directly by adding a new run script phase to the build of the iOS
  ...
  When you create a project with an Android Studio wizard, choose the **Regular framework** option to have this setup generated
  automatically.
...
> When you see that an iOS app depends on an umbrella module in the examples below,
> it means that the iOS app also depends on the umbrella framework generated from this module.
>
{type="tip"}
