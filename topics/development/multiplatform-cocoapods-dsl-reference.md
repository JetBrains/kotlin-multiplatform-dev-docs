...
you can use when working with the [CocoaPods integration](multiplatform-cocoapods-overview.md).

* Learn how to [set up the environment and configure the Kotlin CocoaPods Gradle plugin](multiplatform-cocoapods-overview.md).
* Depending on your project and purposes, you can add dependencies between [a Kotlin project and a Pod library](multiplatform-cocoapods-libraries.md)
as well as [a Kotlin Gradle project and an Xcode project](multiplatform-cocoapods-xcode.md).
