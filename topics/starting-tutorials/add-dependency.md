...
Kotlin Multiplatform gives you a choice between integrating platform-specific libraries for each target app
and using multiplatform libraries,
which support the same functionality across different platforms.
