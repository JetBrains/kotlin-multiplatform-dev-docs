...
1. Choose and install the IDE: KMP is fully supported in IntelliJ IDEA and Android Studio.
    ...
    We recommend installing IDEs using the [JetBrains Toolbox app](https://www.jetbrains.com/toolbox/app/).
...
4. To create iOS applications, you need a macOS machine with [Xcode](https://apps.apple.com/us/app/xcode/id497799835) installed.
    ...
    > The Kotlin Multiplatform IDE plugin makes preflight checks that alert you when Xcode isn't configured correctly.
    >
    {style="note"}
...
Preflight check commands are also available in the **Search Everywhere** dialog.
...
you can see the following modules after the IDE imports your project:
...
The `shared` module is compiled for each target.
...
![JVM app](run-desktop-app.png){width=600}
...
![Web app in a browser](run-wasm-app.png){width=600}
